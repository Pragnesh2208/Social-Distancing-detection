...
#  below function will take care of reading you file into a list of lines.
...
#These beautiful functions makes our day way easier by directly
# reading the network model stored in Darknet model files
# and setting them up to for our detector code.
...
#  It gives you list of all layers used in a network.
...
vs = cv2.VideoCapture("E:/social-distancing-detector-master/pedestrians.mp4")
writer = None
